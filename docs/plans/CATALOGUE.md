# Historical plan catalogue

> AI-generated documentation.

This directory preserves research plans and implementation notes from different
stages of the project. Status statements and proposed methods are historical;
they do not define the submitted experiments. Start with the
[reviewer guide](../REVIEWER_GUIDE.md) for the final study scope.
...
Plan catalogue (historical status descriptions):
