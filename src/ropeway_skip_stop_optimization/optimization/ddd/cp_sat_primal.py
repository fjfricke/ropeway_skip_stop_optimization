    ...
    def solve(
        ...
        *,
        ...
        built = build_ddd_cp_sat_movement(
            ...
            enabled_resource_ids=enabled_resource_ids,
        )
        model = built.model
        max_completion_tick = built.max_completion_tick
        time_by_cabin = built.time_by_cabin
        active_by_cabin = built.active_by_cabin
        selection_by_key = built.selection_by_key
        states_by_cabin = built.states_by_cabin
